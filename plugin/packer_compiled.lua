...
_G.packer_plugins = {
  ...
  ["eslint.nvim"] = {
    config = { 'require("setup/eslint")' },
    loaded = true,
    path = "/Users/kyle/.local/share/nvim/site/pack/packer/start/eslint.nvim",
  ...
  ["vscode.nvim"] = {
    config = { 'require("setup/vscode")' },
    loaded = true,
    path = "/Users/kyle/.local/share/nvim/site/pack/packer/start/vscode.nvim",
